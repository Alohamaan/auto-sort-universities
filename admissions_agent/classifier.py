...
class ThreadClassifier:
    ...
    def classify(self, thread: EmailThread) -> ClassifierResult:
        text = " ".join([thread.snippet, *[m.subject + " " + m.body_text for m in thread.messages]]).lower()
        ...
        return ClassifierResult(
            ...
            institution=InstitutionCandidate(
                canonical_name="Unknown Institution", source_value="", confidence=0.0, is_known=False
            ),
