...
class DecisionEngine:
    ...
    def decide(
        ...
        if result.message_type == MessageType.AUTO_REPLY:
            return DecisionResult(kind=DecisionKind.IGNORE, reason="Auto-reply ignored for eligibility")
        ...
        if (
            ...
            and result.application_status not in {ApplicationStatus.UNKNOWN, current_application_status}
        ):
            return DecisionResult(
